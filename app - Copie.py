...
st.set_page_config(
    ...
    layout="wide", 
    page_icon="🎓",
    initial_sidebar_state="expanded"  # سنمنع إغلاقها بالكود أسفله
)

# ==========================================
# 🎨 CSS: تثبيت القائمة الجانبية (Force Sidebar)
# ==========================================
st.markdown("""
<style>
    ...
    /* --- 🔥🔥🔥 التعديل الجذري: تثبيت القائمة ومنع إغلاقها 🔥🔥🔥 --- */
